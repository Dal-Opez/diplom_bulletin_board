...
urlpatterns = [
    ...
    path('reset_password/', CustomResetPasswordRequestToken.as_view(), name='reset-password'),
    path('reset_password/confirm/', CustomResetPasswordConfirm.as_view(), name='reset-password-confirm'),
]